...
import { signupConfirmationEmailTemplate } from './templates/signupConfirmationEmailTemplate';
import { RegistrationSuccessEmailTemplate } from './templates/RegistrationSuccessEmail';
/* import { EmailServiceInterface, EmailOptions } from './EmailServiceInterface'; */
...
export class ResendEmailService implements EmailServiceInterface {
  ...
  async sendSignupConfirmationEmail(recipientEmail: string, recipientName: string): Promise<void> {
    ...
    const html = signupConfirmationEmailTemplate(recipientName, subject);
  ...
  async sendRegistrationSuccessEmail(recipientEmail: string, recipientName: string): Promise<void> {
    ...
    const html = RegistrationSuccessEmailTemplate(recipientName, subject);
    await this.sendEmail({
      to: recipientEmail,
      subject,
      html,
