...
async function investigateInterfaceDiscrepancy() {
  ...
  try {
    // 1. Verificar todos os serviços no banco
    ...
    // 2. Verificar se os serviços da interface existem no banco
    ...
    // 3. Verificar usuários e parceiros
    ...
    // 4. Verificar se há dados hardcoded ou cache
    console.log('\n🔍 VERIFICANDO POSSÍVEIS FONTES DE DADOS...');

    // Verificar se há arquivos com dados hardcoded
    console.log('ℹ️  Verificando se há dados hardcoded no código...');

    // Verificar se há cache ou localStorage
