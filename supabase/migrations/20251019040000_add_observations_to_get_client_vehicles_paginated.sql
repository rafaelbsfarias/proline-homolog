-- Add observations field to get_client_vehicles_paginated RPC function
-- This allows specialists to view client observations when loading vehicle data
...
-- 2. Recreate the function with the observations field in the SELECT statement
...
BEGIN
    ...
    FROM (
        SELECT
            ...
            comercializacao,
            preparacao,
            observations -- ADDED: Client observations visible to specialist
