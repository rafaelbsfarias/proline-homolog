-- Atualizar função get_partner_dashboard_data para refletir corretamente os status do parceiro
-- Perspective do parceiro: Pendente = novas solicitações | Em Análise = aguardando aprovações
...
BEGIN
    ...
    SELECT json_build_object(
        'total', COUNT(*),
        -- Pendente: Novas solicitações (orçamentos que ainda não foram elaborados ou são drafts)
